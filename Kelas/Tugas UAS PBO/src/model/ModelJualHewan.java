...
public class ModelJualHewan {
    ...
    public JualHewan[] data_penjualan = new JualHewan[1000];
    private int index = 0;

    public void insert(String id, int harga_jual, String tgl_jual, int untung) {
        data_penjualan[index] = new JualHewan(id, harga_jual, tgl_jual, untung);
        index++;
    }
